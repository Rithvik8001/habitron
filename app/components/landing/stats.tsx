...
const testimonials = [
  {
    content: "Habitron helped me build a consistent workout routine. The AI insights are game-changing!",
    author: "Sarah M.",
    role: "Fitness Enthusiast",
  },
  {
    content: "The streak system keeps me motivated. I've never stuck to my habits this long before.",
    author: "Mike R.",
    role: "Software Developer",
  },
  {
    content: "AI suggestions are spot-on! It's like having a personal habit coach.",
    author: "Emily K.",
    role: "Student",
  },
];
    ...
    <div className="relative isolate overflow-hidden py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          >
            Join thousands of people who have transformed their lives using Habitron
          </motion.p>
        </div>
          ...
          <div className="flex gap-8 overflow-hidden py-4">
            <div className="flex animate-infinite-scroll gap-8">
              {[...testimonials, ...testimonials].map((testimonial, idx) => (
                ...
                >
                  <p className="text-gray-900 dark:text-white">{testimonial.content}</p>
